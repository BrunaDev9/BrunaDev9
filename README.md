...
Analista de Dados com foco em **Engenharia de Dados** e **Business Intelligence**.  
Construo pipelines robustos, dashboards que comunicam e automações que escalam.

---

## 💡 O que eu faço na prática

| 🔍 Analiso | 🏗️ Construo | 📊 Visualizo |
|---|---|---|
| Bases com milhões de registros | Pipelines ETL com Docker + PostgreSQL | Dashboards estratégicos no Power BI |
| Correlações e padrões ocultos | Arquiteturas escaláveis em containers | Apps interativos com Streamlit |
| Dados educacionais e esportivos | Automações de relatórios por e-mail | Gráficos analíticos com Plotly |
